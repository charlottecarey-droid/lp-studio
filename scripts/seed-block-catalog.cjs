...
const GENERIC_SEED = [
  ...
  // surface, all FORBIDDEN_PATTERNS pass). Other neutral-sounding blocks
  // (horizontal-showcase, bold-statement, sticky-stack, event-page,
  // spatial-tour) hardcode Dandy lime/forest colors or "Dandy" copyright in
  // their component code or BLOCK_REGISTRY defaults — adding them here would
