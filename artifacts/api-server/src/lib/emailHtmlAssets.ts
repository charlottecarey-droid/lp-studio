    ...
    <tr><td align="center" style="padding:0;">
      ...
      <table role="presentation" class="container paper" cellpadding="0" cellspacing="0" border="0" width="720" style="max-width:720px;background:#F4E8D8;background-image:radial-gradient(ellipse at 90% 0%, rgba(200,146,61,0.18) 0%, transparent 55%);">
        <tr><td class="px-pad" style="padding:96px 56px;">
          ...
          <p style="margin:16px 0 0 0;font-family:'Inter','Helvetica Neue',Helvetica,Arial,sans-serif;font-size:16px;line-height:1.7;color:#2A2722;max-width:520px;">It's built for the whole funnel — per-account microsites for sales, event pages and content hubs for marketing, paid-ads landing pages for growth — all on-brand, without the back-and-forth.</p>
          <p style="margin:16px 0 0 0;font-family:'Inter','Helvetica Neue',Helvetica,Arial,sans-serif;font-size:16px;line-height:1.7;color:#2A2722;max-width:520px;">If anything gets in your way, just hit reply. Glad you're here.</p>
          <table role="presentation" cellpadding="0" cellspacing="0" border="0" style="margin-top:36px;"><tr>
            <td valign="middle">
