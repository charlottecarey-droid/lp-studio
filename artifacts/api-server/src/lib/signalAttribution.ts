...
// Pure domain/email string helpers live in ./emailDomains (no db import) so
// pure modules and unit tests can use them without a DATABASE_URL. Re-exported
// here to keep this module the one-stop import for attribution work.
import { normalizeDomain, deriveDomainFromEmail } from "./emailDomains";
export { normalizeDomain, deriveDomainFromEmail };
