...
const EVENT_AGENDA_GENERIC_PROPS = {
  ...
  team: [
    { name: "Maya Chen", title: "Enterprise Account Executive", linkLabel: "Book time", linkUrl: "#contact" },
    { name: "Jordan Ellis", title: "Solutions Architect" },
    { name: "Priya Raman", title: "Customer Success Director" },
  ],
  showSpeakers: true,
