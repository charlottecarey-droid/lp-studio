...
const ACCOUNT_MICROSITE_GENERIC_PROPS = {
  ...
  reasons: [
    { title: "The cost is compounding", detail: "The manual hours aren't static — volume grows, workarounds multiply, and every quarter of status quo quietly adds to the bill." },
    { title: "The fix no longer needs a big bang", detail: "A staged rollout proves value in one team before anything touches the wider org. The risk profile of switching has fundamentally changed." },
    { title: "Budget timing works in your favor", detail: "Deciding this quarter puts pilot results in hand before next year's budget locks — you negotiate from evidence, not projections." },
  ],
  showApproach: true,
  ...
  phases: [
    { title: "Align on outcomes", timeframe: "Weeks 1–2", detail: "Agree the success criteria in writing, baseline today's numbers, and pick the one workflow we prove first." },
    { title: "Run a focused pilot", timeframe: "Weeks 3–6", detail: "Go live with one team while your current process keeps running in parallel — measured weekly against the baseline." },
    { title: "Review & decide", timeframe: "Weeks 7–8", detail: "Take the measured results to your sponsor. Expand on evidence, or walk away with the baseline work in hand." },
  ],
  showUseCases: true,
  ...
  useCases: [
    { title: "Order entry, off your team's plate", detail: "The re-keying between systems goes first — it's the single biggest source of reclaimed hours for teams your size, and the easiest to measure.", metric: "6–10 hrs/wk" },
    { title: "Exceptions caught upstream", detail: "Checks run at intake instead of after the fact, so errors surface while they're still cheap to fix.", metric: "−72% rework" },
    { title: "Status without the chase", detail: "Owners, queues, and blockers in one live view — the Friday status-chasing thread disappears.", metric: "1 shared view" },
  ],
  showImpact: true,
  ...
  impactStats: [
    { value: "38%", label: "Less manual work", detail: "Across intake, entry, and handoffs — the pilot's headline metric." },
    { value: "90 days", label: "To full payback math", detail: "Enough live data to size the annual return with your finance team." },
    { value: "3.4×", label: "Modeled year-one return", detail: "Hours reclaimed plus error reduction, at your loaded rates." },
  ],
  impactFootnote:
  ...
  personaValues: [
    { role: "Economic buyer", gets: "Payback inside the year and a return that clears the bar, with the math on the record before you sign." },
    { role: "Technical lead", gets: "Security review, SSO, and native integrations — assessed and signed off before the pilot starts, not after." },
    { role: "End users", gets: "Hours back every week and an end to the rework, with a guided rollout that never breaks the day job." },
  ],
  showProof: true,
  proofKicker: "Proof for this buyer",
  proofHeading: "Teams like yours, already there.",
  ...
  faqs: [
    { question: "What does the pilot actually commit us to?", answer: "Six weeks, one team, success criteria we set together in writing. If it misses the bar, you walk — no contract, no fee." },
    { question: "How much of our IT team's time does this take?", answer: "A security review and SSO setup — typically under four hours total. Native connectors cover the standard stack; an open API covers the rest." },
    { question: "What happens to our existing process?", answer: "It keeps running in parallel through the pilot. Nothing is switched off until your team has seen the replacement work at full volume." },
    { question: "How is pricing structured as we grow?", answer: "A flat platform fee with unlimited seats — rollout never fights the meter, and finance gets a number that doesn't move mid-year." },
  ],
  showTeam: true,
...
const EVENT_AGENDA_GENERIC_PROPS = {
  ...
  team: [
    { name: "Maya Chen", title: "Enterprise Account Executive", bio: "Your day-to-day partner on strategy and anything you need on site.", linkLabel: "Book time", linkUrl: "#contact" },
    { name: "Jordan Ellis", title: "Solutions Architect", bio: "Bring him your hardest technical questions — he'll have answers or find them." },
    { name: "Priya Raman", title: "Customer Success Director", bio: "Owns your rollout plan and the milestones we set together this year." },
  ],
  showSpeakers: true,
  ...
  speakers: [
    { name: "Alex Rivera", title: "Chief Executive Officer", bio: "Opens the event with where the platform is going and what ships this year.", sessionTitle: "Opening keynote: the year ahead" },
    { name: "Dr. Simone Vaughn", title: "Head of Research", bio: "On what the last twelve months of data changed about how teams operate at scale.", sessionTitle: "What the data says about scaling" },
  ],
  showSponsors: true,
...
const BUSINESS_CASE_TEMPLATE_SEEDS: GlobalTemplateSeed[] = [
  ...
  },
  {
    ...
    templateDescription:
      "A premium, buyer-facing strategy story a rep generates for one target account: a personalized co-brand hero with count-up stats, a short brief of what we know about them, a personal note from the account team, why-now reasons, the recommended approach, outcome-first use cases, an expected-impact stats chapter, value by role, proof with a featured pull-quote and a logo wall, recommended resources, a mutual action plan, an objection-handling FAQ, the people on your team, and a scheduling close. Personalized behind the scenes — no visible controls. Inherits the tenant brand's colors and logo.",
