// Global marketplace seeds for the full-page template blocks (Event + Case
// Study families). Props mirror the rich, tenant-neutral defaults defined in
// lp-studio's template-page-defaults.ts. Kept in its own module (like
// flagshipTemplates / distinctiveTemplates) and spread into COMBINED.
...
type EventVariant = "noir" | "luminous" | "split";
...
const EVENT_VARIANTS: Record<
  EventVariant,
  { palette: Props; heroImageUrl: string; venueImageUrl: string; speakerPhotos: string[]; galleryImages: string[] }
> = {
  noir: {
    palette: {
      bgColor: "#0b0b0d",
...
function eventSeedProps(variant: EventVariant): Props {
...
type CaseVariant = "metrics" | "editorial" | "modular";

const CASE_VARIANTS: Record<
  CaseVariant,
  { palette: Props; heroImageUrl: string; challengeImageUrl: string; quotePortraitUrl: string; galleryImages: string[]; moduleImages: string[] }
> = {
  metrics: {
    palette: {
      bgColor: "#ffffff",
...
function caseSeedProps(variant: CaseVariant): Props {
...
export const TEMPLATE_PAGE_SEEDS: GlobalTemplateSeed[] = [
  {
    slug: "global-event-noir",
    title: "Event — Editorial Noir",
    templateLabel: "Event — Editorial Noir",
    templateDescription:
      "A dark, high-contrast event registration page with a champagne-gold accent and serif display type. Full agenda, speakers, tickets, FAQ, and a built-in RSVP form. Premium and dramatic.",
    ogImage: "https://images.unsplash.com/photo-1492684223066-81342ee5ff30?w=1200&q=80",
    industry: "events",
    premiumRank: 18,
    blocks: [{ id: "seed-event-noir-1", type: "event-noir", props: eventSeedProps("noir") }],
  },
  {
    slug: "global-event-luminous",
    title: "Event — Luminous Minimal",
    templateLabel: "Event — Luminous Minimal",
    templateDescription:
      "A light, airy, minimal event page with generous whitespace and an indigo accent. Countdown, agenda timeline, speaker grid, tickets, and RSVP form. Clean and modern.",
    ogImage: "https://images.unsplash.com/photo-1556761175-5973dc0f32e7?w=1200&q=80",
    industry: "events",
    premiumRank: 19,
    blocks: [{ id: "seed-event-luminous-1", type: "event-luminous", props: eventSeedProps("luminous") }],
  },
  {
    slug: "global-event-split",
    title: "Event — Split Conference",
    templateLabel: "Event — Split Conference",
    templateDescription:
      "A split-screen conference page with a fixed registration panel and a scrolling content column. Multi-day agenda, speakers, venue, sponsors, and tickets. Built for conversion.",
  ...
  },
  {
    ...
    title: "Case Study — Metrics Forward",
    templateLabel: "Case Study — Metrics Forward",
    templateDescription:
      "A data-led customer story leading with a bold metrics band and mono numerals. Challenge, approach, results, pull quote, deep-dive modules, and takeaways. For results-driven proof.",
    ogImage: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=1200&q=80",
    industry: "generic",
    premiumRank: 21,
    blocks: [{ id: "seed-case-metrics-1", type: "case-metrics", props: caseSeedProps("metrics") }],
  },
  {
    slug: "global-case-editorial",
    title: "Case Study — Editorial Story",
    templateLabel: "Case Study — Editorial Story",
    templateDescription:
      "A magazine-style customer story with serif headlines, a drop-cap standfirst, and a sticky challenge rail. Reads like a feature article — best when narrative leads the proof.",
    ogImage: "https://images.unsplash.com/photo-1499750310107-5fef28a66643?w=1200&q=80",
    industry: "generic",
    premiumRank: 22,
    blocks: [{ id: "seed-case-editorial-1", type: "case-editorial", props: caseSeedProps("editorial") }],
  },
  {
    slug: "global-case-modular",
    title: "Case Study — Modular Report",
    templateLabel: "Case Study — Modular Report",
    templateDescription:
      "A dossier-style case study with a sticky table-of-contents rail and numbered sections. Repeatable deep-dive modules make it easy to extend. For thorough, structured stories.",
    ogImage: "https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=1200&q=80",
    industry: "generic",
    premiumRank: 23,
    blocks: [{ id: "seed-case-modular-1", type: "case-modular", props: caseSeedProps("modular") }],
  },
];
