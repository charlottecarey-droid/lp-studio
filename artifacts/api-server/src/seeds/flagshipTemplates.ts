  ...
  blocks: [
    ...
    },
    {
      ...
      props: {
        ...
        accentColor: "#7B5BFF",
        tiles: [
          { kind: "feature", size: "lg", primary: "Reads your codebase. Writes the PR.", secondary: "Auto-drafts pull requests with reasoning, tests, and changelog notes.", icon: "GitPullRequest" },
          { kind: "stat", size: "md", primary: "12x", secondary: "Faster ticket triage" },
          { kind: "feature", size: "md", primary: "Always-on context", secondary: "Knows your decisions, your stack, your conventions.", icon: "BrainCircuit" },
          { kind: "feature", size: "sm", primary: "Native integrations", secondary: "Slack, Linear, Notion, GitHub.", icon: "Plug" },
          { kind: "feature", size: "sm", primary: "On-prem option", secondary: "VPC deploy. Your weights, your keys.", icon: "ShieldCheck" },
        ],
      },
    },
    {
