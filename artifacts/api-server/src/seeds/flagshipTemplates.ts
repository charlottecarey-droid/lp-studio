  ...
  blocks: [
    ...
    },
    {
      ...
      props: {
        ...
        accentColor: "#22D3EE",
        tiles: [
          { kind: "feature", size: "lg", primary: "Multi-cloud, one console.",      secondary: "Provision, govern, and audit AWS, GCP, Azure and on-prem identically.", icon: "Cloud" },
          { kind: "stat",    size: "md", primary: "32",  secondary: "Regions covered" },
          { kind: "feature", size: "md", primary: "Pre-mapped compliance.",          secondary: "SOC 2, ISO 27001, HIPAA, FedRAMP — every control wired in on day one.", icon: "ShieldCheck" },
          { kind: "feature", size: "sm", primary: "Native integrations.",            secondary: "Okta, Datadog, Splunk, ServiceNow, Snowflake, Terraform Cloud.", icon: "Plug" },
          { kind: "feature", size: "sm", primary: "Policy as code.",                 secondary: "Versioned guardrails. Reviewable. Replayable.", icon: "FileCode" },
          { kind: "stat",    size: "sm", primary: "99.99%", secondary: "Platform SLA" },
        ],
      },
    },
    {
  ...
  blocks: [
    ...
    },
    {
      ...
      props: {
        ...
        accentColor: "#FF4D2E",
        tiles: [
          { kind: "feature", size: "lg", primary: "Brand & identity systems.",        secondary: "Logo, type, color, voice, and a usable guidelines doc your team will actually open.", icon: "Palette" },
          { kind: "stat",    size: "md", primary: "4–8 wks", secondary: "Typical engagement" },
          { kind: "feature", size: "md", primary: "Marketing sites & launches.",      secondary: "Conversion-tuned design + dev-ready handoff for SaaS, fintech, and consumer.", icon: "Globe" },
          { kind: "feature", size: "sm", primary: "Product UI & design systems.",     secondary: "Dashboards, app flows, and components in Figma — built to scale.", icon: "Layers" },
          { kind: "feature", size: "sm", primary: "Pitch & investor decks.",          secondary: "Decks that close rounds — narrative, layout, and slide-by-slide editing.", icon: "Presentation" },
        ],
      },
    },
    {
  ...
  blocks: [
    ...
    },
    {
      ...
      props: {
        ...
        accentColor: "#FF6B2C",
        tiles: [
          { kind: "feature", size: "lg", primary: "Brand systems", secondary: "Logo, type, color, voice, and a real guidelines doc your team will use.", icon: "Palette" },
          { kind: "feature", size: "md", primary: "Landing pages", secondary: "Conversion-tuned, copy + design + dev-ready handoff.", icon: "Globe" },
          { kind: "feature", size: "md", primary: "Product UI", secondary: "Dashboards, app screens, design systems in Figma.", icon: "Layers" },
          { kind: "stat",    size: "sm", primary: "48h", secondary: "Median turnaround" },
          { kind: "feature", size: "sm", primary: "Pitch + decks", secondary: "Investor decks that close rounds.", icon: "Presentation" },
        ],
      },
    },
    {
