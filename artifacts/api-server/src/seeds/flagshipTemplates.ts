  ...
  blocks: [
    ...
    },
    {
      ...
      props: {
        ...
        accentColor: "#7B5BFF",
        tiles: [
          { kind: "feature", size: "lg", primary: "Reads your codebase. Writes the PR.", secondary: "Auto-drafts pull requests with reasoning, tests, and changelog notes.", icon: "GitPullRequest", bgColor: "#15122E", textColor: "#F5F5F7" },
          { kind: "stat", size: "md", primary: "12x", secondary: "Faster ticket triage", bgColor: "#7B5BFF", textColor: "#FFFFFF" },
          { kind: "feature", size: "md", primary: "Always-on context", secondary: "Knows your decisions, your stack, your conventions.", icon: "BrainCircuit", bgColor: "#1A1830", textColor: "#F5F5F7" },
          { kind: "feature", size: "sm", primary: "Native integrations", secondary: "Slack, Linear, Notion, GitHub.", icon: "Plug", bgColor: "#15122E", textColor: "#F5F5F7" },
          { kind: "feature", size: "sm", primary: "On-prem option", secondary: "VPC deploy. Your weights, your keys.", icon: "ShieldCheck", bgColor: "#1A1830", textColor: "#F5F5F7" },
        ],
      },
    },
    {
    ...
    },
    {
      ...
      type: "dandy-versus",
      props: {
        eyebrow: "Vela vs. the rest",
        headline: "Why teams switch from generic copilots to Vela.",
        bgColor: "#0A0A0B",
        leftLabel: "Generic copilot",
        leftTitle: "Autocomplete in a sidebar.",
        leftDesc: "Helpful for snippets — but blind to your codebase, conventions, and the decisions behind them.",
        leftBullets: [
          "No memory of past PRs or decisions",
          "Can't open or review pull requests",
          "Same suggestions for every team",
          "Your code goes to a shared model",
        ],
        leftCtaText: "What you have today",
        leftCtaUrl: "#",
        rightLabel: "Vela",
        rightTitle: "An engineer that ships with you.",
        rightDesc: "Reads your repo end-to-end, drafts complete pull requests, and triages tickets in your team's voice.",
        rightBullets: [
          "Persistent context across your codebase",
          "Drafts PRs with tests and changelog",
          "Tuned to your conventions and stack",
          "VPC deploy — your weights, your keys",
        ],
        rightCtaText: "See Vela in action",
        rightCtaUrl: "#",
      },
    },
    {
      ...
      props: {
        ...
        slides: [
          { src: "https://images.unsplash.com/photo-1551434678-e076c223a692?w=1600&q=80", alt: "Customer 1", caption: "Northwind / Engineering" },
          { src: "https://images.unsplash.com/photo-1556761175-5973dc0f32e7?w=1600&q=80", alt: "Customer 2", caption: "Latticework / Product" },
          { src: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=1600&q=80", alt: "Customer 3", caption: "Veridian / Platform" },
          { src: "https://images.unsplash.com/photo-1518770660439-4636190af475?w=1600&q=80", alt: "Customer 4", caption: "Atlas Robotics / R&D" },
        ],
        bgColor: "#0A0A0B",
        textColor: "#F5F5F7",
        accentColor: "#7B5BFF",
  ...
  blocks: [
    ...
    },
    {
      ...
      props: {
        ...
        accentColor: "#22D3EE",
        tiles: [
          { kind: "feature", size: "lg", primary: "Multi-cloud, one console.",      secondary: "Provision, govern, and audit AWS, GCP, Azure and on-prem identically.", icon: "Cloud", bgColor: "#101A2E", textColor: "#F8FAFC" },
          { kind: "stat",    size: "md", primary: "32",  secondary: "Regions covered", bgColor: "#22D3EE", textColor: "#0B1220" },
          { kind: "feature", size: "md", primary: "Pre-mapped compliance.",          secondary: "SOC 2, ISO 27001, HIPAA, FedRAMP — every control wired in on day one.", icon: "ShieldCheck", bgColor: "#162038", textColor: "#F8FAFC" },
          { kind: "feature", size: "sm", primary: "Native integrations.",            secondary: "Okta, Datadog, Splunk, ServiceNow, Snowflake, Terraform Cloud.", icon: "Plug", bgColor: "#101A2E", textColor: "#F8FAFC" },
          { kind: "feature", size: "sm", primary: "Policy as code.",                 secondary: "Versioned guardrails. Reviewable. Replayable.", icon: "FileCode", bgColor: "#162038", textColor: "#F8FAFC" },
          { kind: "stat",    size: "sm", primary: "99.99%", secondary: "Platform SLA", bgColor: "#0F1A30", textColor: "#F8FAFC" },
        ],
      },
    },
    {
    ...
    },
    {
      ...
      type: "dandy-versus",
      props: {
        eyebrow: "Stitched stack vs. one platform",
        headline: "Replace four vendors with one control plane.",
        bgColor: "#0B1220",
        leftLabel: "Today's stack",
        leftTitle: "Five tools, four contracts, zero plane.",
        leftDesc: "Each cloud has its own console. Each vendor has its own model. Audit prep is a quarterly fire drill.",
        leftBullets: [
          "5+ vendors to invoice and renew",
          "Inconsistent IAM across clouds",
          "Manual SOC 2 / ISO evidence",
          "Tribal-knowledge runbooks",
        ],
        leftCtaText: "What you have today",
        leftCtaUrl: "#",
        rightLabel: "Our platform",
        rightTitle: "One console. Every cloud. Every control.",
        rightDesc: "Provision, govern, observe, and audit AWS, GCP, Azure, and on-prem from a single, policy-driven plane.",
        rightBullets: [
          "One contract, one console",
          "Unified RBAC + SCIM + SSO",
          "Always-on audit reports",
          "Codified, replayable workflows",
        ],
        rightCtaText: "Book a platform tour",
        rightCtaUrl: "#tour",
      },
    },
    {
...
const premiumSaas: GlobalTemplateSeed = {
  ...
  blocks: [
    ...
    },
    {
      ...
      props: {
        rows: [
          { headline: "Pipeline that sells itself", body: "AI-suggested next steps, auto-summaries on every deal, and one-click follow-ups.", imageUrl: "https://images.unsplash.com/photo-1556761175-5973dc0f32e7?w=1200&q=80", imagePosition: "right" },
          { headline: "Books that close themselves", body: "Real-time cash position, auto-categorized expenses, and one-click month-end.", imageUrl: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=1200&q=80", imagePosition: "left" },
          { headline: "Ops that run on rails", body: "Templated SOPs, role-based assignments, and a calendar your team will actually follow.", imageUrl: "https://images.unsplash.com/photo-1497366216548-37526070297c?w=1200&q=80", imagePosition: "right" },
        ],
      },
    },
    {
  ...
  blocks: [
    ...
    },
    {
      ...
      props: {
        ...
        slides: [
          { src: "https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=1600&q=80", alt: "Dining room", caption: "The room" },
          { src: "https://images.unsplash.com/photo-1510812431401-41d2bd2722f3?w=1600&q=80", alt: "Wine cellar", caption: "Cellar" },
          { src: "https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=1600&q=80", alt: "Open kitchen", caption: "Kitchen" },
          { src: "https://images.unsplash.com/photo-1467003909585-2f8a72700288?w=1600&q=80", alt: "Tasting menu plate", caption: "The plate" },
        ],
        bgColor: "#1A1610",
        textColor: "#FAF7F2",
        accentColor: "#C7A664",
  ...
  blocks: [
    {
      ...
      props: {
        ...
        statement: "I help ambitious teams turn fuzzy ideas into <em>beautiful, opinionated</em> products.",
    ...
    },
    {
      ...
      props: {
        ...
        slides: [
          { src: "https://images.unsplash.com/photo-1561070791-2526d30994b8?w=1600&q=80", alt: "Project 1", caption: "Northwind / Identity 2024" },
          { src: "https://images.unsplash.com/photo-1542744173-8e7e53415bb0?w=1600&q=80", alt: "Project 2", caption: "Latticework / Product Design" },
          { src: "https://images.unsplash.com/photo-1559028012-481c04fa702d?w=1600&q=80", alt: "Project 3", caption: "Helix / Web Refresh" },
          { src: "https://images.unsplash.com/photo-1517292987719-0369a794ec0f?w=1600&q=80", alt: "Project 4", caption: "Fieldnotes / App" },
        ],
        bgColor: "#0B0B0C",
        textColor: "#F5F5F7",
        accentColor: "#FF4D2E",
    ...
    },
    {
      ...
      props: {
        ...
        accentColor: "#FF4D2E",
        tiles: [
          { kind: "feature", size: "lg", primary: "Brand & identity systems.",        secondary: "Logo, type, color, voice, and a usable guidelines doc your team will actually open.", icon: "Palette", bgColor: "#0B0B0C", textColor: "#F5F5F7" },
          { kind: "stat",    size: "md", primary: "4–8 wks", secondary: "Typical engagement", bgColor: "#FF4D2E", textColor: "#FFFFFF" },
          { kind: "feature", size: "md", primary: "Marketing sites & launches.",      secondary: "Conversion-tuned design + dev-ready handoff for SaaS, fintech, and consumer.", icon: "Globe", bgColor: "#F5F0EA", textColor: "#0B0B0C" },
          { kind: "feature", size: "sm", primary: "Product UI & design systems.",     secondary: "Dashboards, app flows, and components in Figma — built to scale.", icon: "Layers", bgColor: "#0B0B0C", textColor: "#F5F5F7" },
          { kind: "feature", size: "sm", primary: "Pitch & investor decks.",          secondary: "Decks that close rounds — narrative, layout, and slide-by-slide editing.", icon: "Presentation", bgColor: "#F5F0EA", textColor: "#0B0B0C" },
        ],
      },
    },
    {
    ...
    },
    {
      ...
      props: {
        images: [
          { src: "https://images.unsplash.com/photo-1611162617213-7d7a39e9b1d7?w=400&q=80", alt: "Press 1" },
          { src: "https://images.unsplash.com/photo-1611162616305-c69b3fa7fbe0?w=400&q=80", alt: "Press 2" },
          { src: "https://images.unsplash.com/photo-1611162618071-b39a2ec055fb?w=400&q=80", alt: "Press 3" },
          { src: "https://images.unsplash.com/photo-1611605698335-8b1569810432?w=400&q=80", alt: "Press 4" },
        ],
      },
    },
    {
  ...
  blocks: [
    ...
    },
    {
      ...
      props: {
        ...
        accentColor: "#FF6B2C",
        tiles: [
          { kind: "feature", size: "lg", primary: "Brand systems", secondary: "Logo, type, color, voice, and a real guidelines doc your team will use.", icon: "Palette", bgColor: "#0F0F10", textColor: "#F5F2EC" },
          { kind: "feature", size: "md", primary: "Landing pages", secondary: "Conversion-tuned, copy + design + dev-ready handoff.", icon: "Globe", bgColor: "#FAF7F2", textColor: "#0F0F10" },
          { kind: "feature", size: "md", primary: "Product UI", secondary: "Dashboards, app screens, design systems in Figma.", icon: "Layers", bgColor: "#FAF7F2", textColor: "#0F0F10" },
          { kind: "stat",    size: "sm", primary: "48h", secondary: "Median turnaround", bgColor: "#FF6B2C", textColor: "#FFFFFF" },
          { kind: "feature", size: "sm", primary: "Pitch + decks", secondary: "Investor decks that close rounds.", icon: "Presentation", bgColor: "#0F0F10", textColor: "#F5F2EC" },
        ],
      },
    },
    {
    ...
    },
    {
      ...
      props: {
        ...
        slides: [
          { src: "https://images.unsplash.com/photo-1561070791-2526d30994b8?w=1600&q=80", alt: "Work 1", caption: "Northwind / Identity" },
          { src: "https://images.unsplash.com/photo-1559028012-481c04fa702d?w=1600&q=80", alt: "Work 2", caption: "Helix / Web" },
          { src: "https://images.unsplash.com/photo-1542744173-8e7e53415bb0?w=1600&q=80", alt: "Work 3", caption: "Latticework / App" },
          { src: "https://images.unsplash.com/photo-1517292987719-0369a794ec0f?w=1600&q=80", alt: "Work 4", caption: "Atlas / Brand" },
        ],
        bgColor: "#FAF7F2",
        textColor: "#0F0F10",
        accentColor: "#FF6B2C",
...
const blogSeriesEditorial: GlobalTemplateSeed = {
  slug: "global-flagship-blog-series-editorial",
  title: "Blog Series — Editorial",
  templateLabel: "Blog Series — Editorial",
  templateDescription:
    "A premium editorial home for an ongoing essay or article series — magazine-style hero, featured essay, article archive, topic index, contributor bios, and a newsletter subscribe block. Cream-and-ink palette with a serif display face.",
  ...
  blocks: [
    {
      ...
      props: {
        ...
        heroDeck:
          "A quarterly editorial series on craft, design, and the technology of attention — long essays, field notes, and the occasional quiet argument.",
        heroCtaText: "Start reading",
        heroCtaUrl: "#archive",
        heroMetaLeft: "Issue 04",
        heroMetaRight: "12 min read",
        heroImageUrl: "https://images.unsplash.com/photo-1455390582262-044cdead277a?w=1200&q=80",
        heroCaptionLabel: "In this issue",
        heroCaptionText: "Six essays · Three contributors",
        archiveEyebrow: "Latest from the archive",
        archiveLinkText: "View all essays",
        archiveLinkUrl: "#",
        ...
        articles: [
          { category: "Design", title: "Designing for the second read", excerpt: "How layout, rhythm, and restraint change what a returning reader notices the next time around.", author: "Jonas Auclair", avatarUrl: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=200&q=80", date: "Feb 27", readTime: "8 min", imageUrl: "https://images.unsplash.com/photo-1499750310107-5fef28a66643?w=600&q=80", href: "#" },
          { category: "Engineering", title: "Building tools that stay out of the way", excerpt: "The quiet discipline of subtraction, and why our best feature this quarter was the one we removed.", author: "Priya Nair", avatarUrl: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=200&q=80", date: "Feb 21", readTime: "11 min", imageUrl: "https://images.unsplash.com/photo-1486312338219-ce68d2c6f44d?w=600&q=80", href: "#" },
          { category: "Craft", title: "Ink, paper, and the case for friction", excerpt: "A short study of why analog rituals keep returning to the most digital teams we know.", author: "Mara Velasquez", avatarUrl: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=200&q=80", date: "Feb 14", readTime: "6 min", imageUrl: "https://images.unsplash.com/photo-1456513080510-7bf3a84b82f8?w=600&q=80", href: "#" },
          { category: "Culture", title: "The empty room as a design brief", excerpt: "What gallery spaces taught us about negative space, attention, and the courage to leave things out.", author: "Jonas Auclair", avatarUrl: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=200&q=80", date: "Feb 9", readTime: "9 min", imageUrl: "https://images.unsplash.com/photo-1497032205916-ac775f0649ae?w=600&q=80", href: "#" },
          { category: "Field Notes", title: "Notes from a month without dashboards", excerpt: "We turned off the metrics and ran the studio on intuition. Here is what broke, and what didn't.", author: "Priya Nair", avatarUrl: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=200&q=80", date: "Feb 2", readTime: "7 min", imageUrl: "https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=600&q=80", href: "#" },
          { category: "Craft", title: "Letterpress lessons for the screen", excerpt: "Constraints of the press, reimagined for typography that has to survive any device.", author: "Mara Velasquez", avatarUrl: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=200&q=80", date: "Jan 28", readTime: "10 min", imageUrl: "https://images.unsplash.com/photo-1503551723145-6c040742065b?w=600&q=80", href: "#" },
        ],
        ...
        contributors: [
          { name: "Mara Velasquez", role: "Editor in Chief", bio: "Writes about attention, craft, and the slow web. Previously design editor at a publication you've probably read on a train.", avatarUrl: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=200&q=80", twitterUrl: "#", linkedinUrl: "#", websiteUrl: "#" },
          { name: "Jonas Auclair", role: "Design Correspondent", bio: "Studies the spaces between things — typographic, architectural, and otherwise. Believes good layout is an act of generosity.", avatarUrl: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=200&q=80", twitterUrl: "#", linkedinUrl: "#", websiteUrl: "#" },
          { name: "Priya Nair", role: "Engineering at Large", bio: "Builds the quiet infrastructure behind the words. Has strong, well-reasoned opinions about footnotes and load times.", avatarUrl: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=200&q=80", twitterUrl: "#", linkedinUrl: "#", websiteUrl: "#" },
        ],
...
const storefrontDtc: GlobalTemplateSeed = {
  slug: "global-flagship-storefront-dtc",
  title: "Storefront — DTC Shop",
  templateLabel: "Storefront — DTC Shop",
  templateDescription:
    "A premium direct-to-consumer storefront — announcement bar, sticky nav with cart, product hero with variants, value props, collection banners, product grid, customer reviews, a bundle offer, and a footer newsletter. Configured here as a specialty coffee brand.",
  ...
  blocks: [
    {
      ...
      props: {
        ...
        heroPrice: "$22",
        heroComparePrice: "$26",
        heroImageUrl: "https://images.unsplash.com/photo-1559056199-641a0ac8b55e?w=1200&q=80",
        ...
        collections: [
          { eyebrow: "Subscribe & save", title: "The Coffee Club", description: "Fresh beans on your schedule. Pause or cancel anytime. Save 15% on every bag.", ctaLabel: "Start your subscription", ctaUrl: "#shop", variant: "dark", imageUrl: "https://images.unsplash.com/photo-1442512595331-e89e73853f31?w=800&q=80" },
          { eyebrow: "Limited release", title: "Ethiopia Yirgacheffe", description: "Bright, floral, and citrus-forward. Only 200 bags roasted this season.", ctaLabel: "Explore collection", ctaUrl: "#shop", variant: "accent", imageUrl: "https://images.unsplash.com/photo-1497935586351-b67a49e012bf?w=800&q=80" },
        ],
        ...
        products: [
          { name: "Midnight Reserve", category: "Dark roast", price: "$22", comparePrice: "$26", rating: 4.9, reviewCount: 412, tag: "Bestseller", href: "#", imageUrl: "https://images.unsplash.com/photo-1559056199-641a0ac8b55e?w=600&q=80" },
          { name: "Sunrise Blend", category: "Medium roast", price: "$20", rating: 4.8, reviewCount: 286, href: "#", imageUrl: "https://images.unsplash.com/photo-1514432324607-a09d9b4aefdd?w=600&q=80" },
          { name: "Ethiopia Yirgacheffe", category: "Light roast", price: "$24", rating: 5.0, reviewCount: 134, tag: "New", href: "#", imageUrl: "https://images.unsplash.com/photo-1447933601403-0c6688de566e?w=600&q=80" },
          { name: "Decaf Nightcap", category: "Swiss water decaf", price: "$21", rating: 4.7, reviewCount: 98, href: "#", imageUrl: "https://images.unsplash.com/photo-1521302200778-33500795e128?w=600&q=80" },
        ],
        ...
        reviews: [
          { name: "Jordan M.", location: "Portland, OR", quote: "The freshest coffee I've ever had delivered. You can taste the difference when it's roasted to order — Midnight Reserve is unreal.", rating: 5, avatarUrl: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=200&q=80" },
          { name: "Priya S.", location: "Austin, TX", quote: "Switched my whole office to the Coffee Club subscription. Shipping is fast, packaging is gorgeous, and the beans are consistently excellent.", rating: 5, avatarUrl: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=200&q=80" },
          { name: "Marcus T.", location: "Brooklyn, NY", quote: "The Ethiopia Yirgacheffe is bright and floral without being acidic. Easily my favorite light roast — I re-order every month.", rating: 5, avatarUrl: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=200&q=80" },
        ],
        ...
        bundleCtaUrl: "#shop",
        bundleImageUrl: "https://images.unsplash.com/photo-1485808191679-5f86510681a2?w=1000&q=80",
