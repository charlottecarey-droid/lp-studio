...
import logoLibraryRouter from "./logo-library";
import betaOfferRouter from "./beta-offer";
...
import brandImportImagesRouter from "./brand-import-images";
...
import pageStyleFromUrlRouter from "./page-style-from-url";
import seoAnalyzeRouter from "./seo-analyze";
import seoMetaGenerateRouter from "./seo-meta-generate";
import ogDefaultsGenerateRouter from "./og-defaults-generate";
...
import outreachDefaultsRouter from "./outreach-defaults";
...
router.use(outreachDefaultsRouter);
...
router.use(logoLibraryRouter);
router.use(betaOfferRouter);
...
router.use(brandImportImagesRouter);
...
router.use(pageStyleFromUrlRouter);
router.use(seoAnalyzeRouter);
router.use(seoMetaGenerateRouter);
router.use(ogDefaultsGenerateRouter);
