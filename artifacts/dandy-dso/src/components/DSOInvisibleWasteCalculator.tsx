...
}: {label: string;value: number | string;onChange: (v: string) => void;prefix?: string;suffix?: string;type?: string;[k: string]: any;}) =>
<div>
    ...
    <div className="relative">
      ...
      className={`w-full rounded-lg border border-border bg-background py-2.5 text-sm text-foreground focus:outline-none focus:ring-2 focus:ring-primary/30 ${prefix ? "pl-7 pr-3" : suffix ? "pl-3 pr-7" : "px-3"}`}
      {...props} />
...
const DSOInvisibleWasteCalculator = () => {
  ...
  const resto = useMemo(() => {
    ...
    return { currentRemakes, improvedRemakes, remakesAvoided, recoveredProdMonth, recoveredProdYear, chairTimeSavedMonth, chairTimeSavedYear, labCostsAvoidedMonth, labCostsAvoidedYear, opptyProdMonth, opptyProdYear, totalUpsideYear };
  ...
  const exportPDF = useCallback(() => {
    ...
    function buildPDF(logoData: string) {
      ...
      doc.save("dandy-invisible-waste-calculator.pdf");
    }
  ...
  return (
    <section id="waste-calculator" className="section-padding bg-background">
      <div className="max-w-[1100px] mx-auto px-6 md:px-10">
        ...
        <div className="text-center mb-14">
          ...
          <motion.h2
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="text-display text-foreground">Calculate the cost of inaction.
          </motion.h2>
          <motion.p
            ...
            className="mt-4 text-base text-muted-foreground max-w-lg mx-auto">Estimate the cost of remakes and lost chair time across your DSO.
        ...
        <motion.div
          ...
          <input
            type="number" min={1} max={2000} value={practices}
          ...
          <div className="lg:col-span-2">
            <div className="rounded-2xl bg-primary p-6 md:p-8 space-y-1 sticky top-24">
              ...
              <div className="pt-2">
                ...
                <button
                  onClick={exportPDF}
                  className="mt-4 w-full flex items-center justify-center gap-2 rounded-full border border-primary-foreground/20 py-2.5 text-xs font-semibold text-primary-foreground hover:bg-primary-foreground/10 transition-colors">
...
export default DSOInvisibleWasteCalculator;