    ...
    <section ref={sectionRef} id="contact" className="relative overflow-hidden bg-primary">
      ...
      <div className="relative section-padding z-[1]">
        ...
        <motion.div style={{ y: contentY }} className="max-w-[720px] mx-auto px-6 md:px-10 text-center relative z-10">
          <motion.p initial={{ opacity: 0, y: 10 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-[11px] font-semibold tracking-[0.2em] text-accent-warm mb-6 uppercase">
            Next Steps
          </motion.p>

          <motion.h2 initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.7 }} className="text-display text-primary-foreground">Prove ROI.
            <br />Then scale.
          </motion.h2>
          <motion.p initial={{ opacity: 0, y: 15 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.1 }} className="mt-6 text-body-lg text-primary-foreground/65">
          ...
          <motion.form
            ...
            onSubmit={async (e) => {e.preventDefault(); await supabase.from('cta_submissions').insert({ email }); setDemoOpen(true);}}>
          ...
          <motion.p initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} transition={{ delay: 0.3 }} className="mt-12 text-[11px] text-primary-foreground/35 tracking-wide">
