      ...
      <div className="relative z-10 w-full px-20 flex items-center gap-16">
        ...
        <div className="flex flex-col gap-5 w-[38%] flex-shrink-0">
          ...
          <div style={{ fontSize: '4.6vw', lineHeight: 1.1, letterSpacing: '-0.02em', display: 'flex', flexDirection: 'column', gap: 0 }}>
            ...
            <div style={{ color: '#C7E738', fontWeight: 400, display: 'flex', flexWrap: 'wrap', columnGap: '0.24em', rowGap: 0, alignItems: 'baseline' }}>
          ...
          >
            {[
              ...
              <div key={l} className="flex flex-col gap-1">
                ...
                <span style={{ color: 'rgba(169, 184, 195, 0.7)', fontSize: '0.85vw', letterSpacing: '0.14em', textTransform: 'uppercase' }}>{l}</span>
              </div>
            ))}
          </motion.div>
        </div>
