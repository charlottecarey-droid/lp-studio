 ...
 * than piggy-backing on the brand-settings save bar.
 */
function MicrositeLinksCard() {
  ...
  const handleSave = async () => {
    setSaving(true);
    try {
      // Drop fully-empty rows silently; flag half-filled rows inline so
      // the user can fix them instead of seeing an opaque server error.
