            ...
            {props.showNavbar !== false && (
              <>
                ...
                <Field label="Navbar CTA URL / anchor">
                  <Input value={props.navCtaUrl ?? ""} onChange={(e) => set("navCtaUrl", e.target.value)} placeholder="#support" className="text-xs h-8" />
                </Field>
                <div className="space-y-2 pt-1">
                  <div className="text-[11px] uppercase tracking-wider text-muted-foreground">Anchor links (0–4) — ids: #plan, #checklist, #support</div>
                  {navLinks.map((l, i) => (
