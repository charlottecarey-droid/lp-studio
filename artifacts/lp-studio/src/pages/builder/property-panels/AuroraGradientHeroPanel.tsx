...
/** BlockAuroraGradientHero primary & secondary actions (all five). */
const AURORA_CTA_ACTIONS = ["url", "chilipiper", "modal-form", "modal-chilipiper", "video-modal"] as const;
...
export function AuroraGradientHeroPanel({ props, onChange, ctaSource }: Props) {
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="space-y-3">
        ...
        {/* Primary CTA — label + colors stay panel-owned; action suite is shared. */}
        <div className="space-y-2 border rounded-md p-2.5">
          ...
          <CtaActionConfigSection
            ...
            onChange={(v) => onChange({ ...props, ...v } as AuroraGradientHeroBlockProps)}
            allowedActions={AURORA_CTA_ACTIONS}
            hideModalConfig
            {...ctaSource}
          />
          <div className="grid grid-cols-2 gap-2">
