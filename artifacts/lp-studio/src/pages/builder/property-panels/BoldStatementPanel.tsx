...
/** BlockBoldStatement renders only these primary actions. */
const BOLD_STATEMENT_CTA_ACTIONS = ["url", "chilipiper", "modal-form", "modal-chilipiper"] as const;
...
export function BoldStatementPanel({ props, onChange, ctaSource }: Props) {
    ...
    <div className="space-y-5">
      ...
      <div className="space-y-3">
        ...
        <CtaActionConfigSection
          ...
          onChange={(v) => onChange({ ...props, ...v } as BoldStatementBlockProps)}
          allowedActions={BOLD_STATEMENT_CTA_ACTIONS}
          {...ctaSource}
        />
      </div>
