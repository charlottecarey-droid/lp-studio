...
/** BlockParallaxLayersHero primary & secondary actions (all five). */
const PARALLAX_LAYERS_CTA_ACTIONS = ["url", "chilipiper", "modal-form", "modal-chilipiper", "video-modal"] as const;
...
export function ParallaxLayersHeroPanel({ props, onChange, ctaSource }: Props) {
      ...
      <div className="space-y-3">
        ...
        <div className="space-y-2 border rounded-md p-2.5">
          ...
          <CtaActionConfigSection
            ...
            onChange={(v) => onChange({ ...props, ...v } as ParallaxLayersHeroBlockProps)}
            allowedActions={PARALLAX_LAYERS_CTA_ACTIONS}
            hideModalConfig
            {...ctaSource}
          />
          <div className="grid grid-cols-2 gap-2">
