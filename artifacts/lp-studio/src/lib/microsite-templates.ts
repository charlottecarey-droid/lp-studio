  ...
  return [
    ...
    },
    {
      ...
      props: {
        ...
        layout: "4-col",
        challenges: [
          { title: "Fragmented Lab Quality", desc: "Inconsistent results across lab vendors create unpredictable remake rates and patient dissatisfaction — with no easy way to intervene at scale." },
          { title: "Siloed Performance Data", desc: "Without centralized reporting, leaders can't see which locations struggle with remakes, acceptance rates, or chair-time losses until the damage compounds." },
          { title: "High Denture Chair Time", desc: "Traditional denture workflows require multiple lengthy appointments, increasing chair-time costs and lowering same-day-treatment conversion rates." },
          { title: "Expansion Complexity", desc: "Each new acquisition brings new lab relationships, inconsistent workflows, and additional management overhead that strain clinical ops at scale." },
        ],
      },
    },
    {
      ...
      props: {
        ...
        ctaUrl: DANDY_CTA_URL,
        rows: [
          { need: "Consistent quality across every location", dandy: "AI-driven quality control: 96% first-time right", traditional: "Variable — depends on lab & technician" },
          { need: "Network-wide performance data", dandy: "Dandy Hub: real-time insights, benchmarking, alerts", traditional: "Siloed per-practice reporting or none" },
          { need: "Fast case turnaround", dandy: "5–7 day average, predictable SLAs at scale", traditional: "7–14 days, no enterprise SLA" },
          { need: "Same-day denture solution", dandy: "Dandy Smile+: chair-time cut by up to 50%", traditional: "3–5 appointments required" },
          { need: "Integration & billing support", dandy: "Full EHR compatibility + billing support team", traditional: "Limited, practice-by-practice" },
          { need: "Expansion readiness", dandy: "Instant onboarding for acquired practices", traditional: "Re-negotiate per acquisition" },
        ],
      },
    },
    {
      ...
      props: {
        ...
        cases: [
          { name: "Regional 80-Location DSO", stat: "28%", label: "reduction in lab remakes", quote: "Dandy's AI quality control caught issues before they ever reached the patient. Our doctors noticed the difference in the first month.", author: "VP of Clinical Operations" },
          { name: "Pacific Northwest Group (42 Offices)", stat: "45%", label: "chair time saved on dentures", quote: "Smile+ transformed our denture workflow. We went from 3–5 appointments to a true same-day solution our providers actually love.", author: "CEO" },
          { name: "Multi-State Expansion Group", stat: "31%", label: "lift in case acceptance", quote: "The Dandy Hub gave our regional directors real visibility for the first time. We knew exactly where to focus and revenue followed.", author: "Director of Practice Development" },
        ],
      },
    },
    {
      id: makeId("dso-pilot-steps"),
      type: "dso-pilot-steps",
      props: {
        eyebrow: "How It Works",
        headline: "Start small. Prove it out. Then scale.",
        subheadline: "Growth should be proven before it's scaled. Dandy helps validate impact with a small number of locations, then equips {company_name} to expand with confidence.",
        backgroundStyle: "white",
      },
    },
    {
...
function businessCaseSplitBlocks(): PageBlock[] {
  return [createBlock("business-case-split")];
}
