...
export const BLOCK_REGISTRY: BlockDefinition[] = [
  ...
  },
  {
    ...
    defaultProps: (): ValuePillarsColorBlockCardsBlockProps => ({
      ...
      cardRadius: "2xl",
      items: [
        { icon: "Rocket", title: "Launch faster", description: "Skip the setup headaches and ship sooner.", image: "https://images.unsplash.com/photo-1551434678-e076c223a692?auto=format&fit=crop&w=1200&q=80" },
        { icon: "TrendingUp", title: "Grow steadily", description: "Tools that scale right alongside your business.", image: "https://images.unsplash.com/photo-1522071820081-009f0129c71c?auto=format&fit=crop&w=1200&q=80" },
        { icon: "HeartHandshake", title: "Real support", description: "A team that actually answers when you need help.", image: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&w=1200&q=80" },
      ],
      ...sectionCtaDefaults(),
    }),
    thumbnail: () => (
  ...
  },
  {
    ...
    defaultProps: (): ValuePillarsHeadlineBadgeBlockProps => ({
      ...
      items: [
        ...
        { icon: "Award", title: "Proven results", description: "Trusted by teams who needed something that just works.", image: "https://images.unsplash.com/photo-1600880292203-757bb62b4baf?auto=format&fit=crop&w=1200&q=80" },
      ],
      ...sectionCtaDefaults(),
    }),
    thumbnail: () => (
  ...
  },
  {
    ...
    defaultProps: (): FeaturePhotoCardsBlockProps => ({
      ...
      cardRadius: "2xl",
      items: [
        { icon: "Image", title: "Visual storytelling", description: "Lead with imagery that shows the value instantly.", image: "https://images.unsplash.com/photo-1522071820081-009f0129c71c?auto=format&fit=crop&w=1200&q=80" },
        { icon: "PenTool", title: "Make it yours", description: "Adjust colors, copy, and layout to match your brand.", image: "https://images.unsplash.com/photo-1556761175-5973dc0f32e7?auto=format&fit=crop&w=1200&q=80" },
        { icon: "Share2", title: "Share anywhere", description: "Publish once and reach every channel that matters.", image: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&w=1200&q=80" },
      ],
      ...sectionCtaDefaults(),
    }),
    thumbnail: () => (
  ...
  },
  {
    ...
    defaultProps: (): FeatureCardGridBlockProps => ({
      ...
      items: [
        ...
        { icon: "Search", title: "Find it fast", description: "Powerful search surfaces exactly what you're after.", image: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&w=1200&q=80" },
        { icon: "Cloud", title: "Always in sync", description: "Your work stays current across every device.", image: "https://images.unsplash.com/photo-1600880292203-757bb62b4baf?auto=format&fit=crop&w=1200&q=80" },
      ],
      ...sectionCtaDefaults(),
    }),
    thumbnail: () => (
  ...
  },
  {
    ...
    defaultProps: (): FeatureBigFeaturesBlockProps => ({
      ...
      items: [
        ...
        { icon: "Wand2", title: "Effortless to use", description: "Thoughtful design means your team gets value from day one, no training required.", image: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&w=1200&q=80" },
        { icon: "LineChart", title: "Insights that guide you", description: "Clear, actionable data helps you make confident decisions faster.", image: "https://images.unsplash.com/photo-1522071820081-009f0129c71c?auto=format&fit=crop&w=1200&q=80" },
      ],
      ...sectionCtaDefaults(),
    }),
    thumbnail: () => (
