  ...
  },
  {
    ...
    defaultProps: (): ValuePillarsOutlinedCardsBlockProps => ({
      ...
      items: [
        ...
        { icon: "Lock", title: "Private and safe", description: "Built-in protections keep your customers' data secure.", linkLabel: "Learn more" },
        { icon: "Workflow", title: "Fits your flow", description: "Connects to the tools your team already relies on.", linkLabel: "Learn more" },
      ],
      ...sectionCtaDefaults(),
    }),
    thumbnail: () => (
  ...
  },
  {
    ...
    defaultProps: (): ValuePillarsColorBlockCardsBlockProps => ({
      ...
      items: [
        ...
        { icon: "HeartHandshake", title: "Real support", description: "A team that actually answers when you need help.", linkLabel: "Learn more", image: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&w=1200&q=80" },
      ],
      ...sectionCtaDefaults(),
    }),
    thumbnail: () => (
  ...
  },
  {
    ...
    defaultProps: (): ValuePillarsDividedColumnsBlockProps => ({
      ...
      items: [
        ...
        { icon: "Users", title: "Work together", description: "Keep everyone aligned in one shared, organized space.", linkLabel: "Learn more" },
        { icon: "BarChart3", title: "See results", description: "Clear reporting shows exactly what's working.", linkLabel: "Learn more" },
      ],
      ...sectionCtaDefaults(),
    }),
    thumbnail: () => (
  ...
  },
  {
    ...
    defaultProps: (): ValuePillarsCardColumnsBlockProps => ({
      ...
      items: [
        ...
        { icon: "Star", title: "Built to impress", description: "A polished feel that reflects well on your brand.", linkLabel: "Learn more" },
      ],
      ...sectionCtaDefaults(),
    }),
    thumbnail: () => (
  ...
  },
  {
    ...
    defaultProps: (): FeaturePhotoCardsBlockProps => ({
      ...
      items: [
        ...
        { icon: "Share2", title: "Share anywhere", description: "Publish once and reach every channel that matters.", linkLabel: "Learn more", image: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&w=1200&q=80" },
      ],
      ...sectionCtaDefaults(),
    }),
    thumbnail: () => (
