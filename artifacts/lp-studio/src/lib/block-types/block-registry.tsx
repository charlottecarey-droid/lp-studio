...
export const BLOCK_REGISTRY: BlockDefinition[] = [
  ...
  },
  {
    ...
    defaultProps: (): AiScanHeroBlockProps => ({
      ...
      headlineScale: 1,
      imageUrl: "https://images.unsplash.com/photo-1559757175-0eb30cd8c063?q=80&w=1600&h=900&fit=crop",
      imageAlt: "Specialist reviewing an AI-analyzed scan on screen",
      backgroundVideoUrl: "",
      ctaText: "Get started",
      ctaUrl: "#",
      ctaAction: "url",
  ...
  },
  {
    ...
    defaultProps: (): ValuePillarsColorBlockCardsBlockProps => ({
      ...
      cardRadius: "none",
      items: [
        { icon: "Rocket", title: "Launch faster", description: "Skip the setup headaches and ship sooner.", linkLabel: "Learn more" },
        { icon: "TrendingUp", title: "Grow steadily", description: "Tools that scale right alongside your business.", linkLabel: "Learn more" },
        { icon: "HeartHandshake", title: "Real support", description: "A team that actually answers when you need help.", linkLabel: "Learn more" },
      ],
      ...sectionCtaDefaults(),
    }),
    thumbnail: () => (
  ...
  },
  {
    ...
    defaultProps: (): FeaturePhotoCardsBlockProps => ({
      ...
      cardRadius: "none",
      items: [
        { icon: "Image", title: "Visual storytelling", description: "Lead with imagery that shows the value instantly.", linkLabel: "Learn more" },
        { icon: "PenTool", title: "Make it yours", description: "Adjust colors, copy, and layout to match your brand.", linkLabel: "Learn more" },
        { icon: "Share2", title: "Share anywhere", description: "Publish once and reach every channel that matters.", linkLabel: "Learn more" },
      ],
      ...sectionCtaDefaults(),
    }),
    thumbnail: () => (
