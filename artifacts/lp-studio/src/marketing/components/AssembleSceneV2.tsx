...
const LIME = "#3C38B8";          // primary accent (indigo, matches app)
...
const TEXT = "#25214D";          // deep indigo ink text (matches marketing --ink)
                ...
                <div className="flex items-center gap-3 ml-auto">
                  ...
                  <div className="hidden md:flex items-center">
                    {[
                      ...
                      { initials: "AR", color: "linear-gradient(135deg,#6C68F0 0%,#3C38B8 100%)" },
