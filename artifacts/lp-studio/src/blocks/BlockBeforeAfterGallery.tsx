          ...
          {props.pairs.map((pair, i) => (
            <div key={i} className="grid md:grid-cols-2 gap-4 md:gap-6">
              <figure className="relative">
                <span
                  className="absolute top-3 left-3 z-10 text-[10px] uppercase tracking-[0.2em] px-2 py-1 rounded"
              ...
              {pair.caption && (
                <p className="md:col-span-2 text-sm opacity-70 italic text-center">
                  {pair.caption}
                </p>
              )}
            </div>
