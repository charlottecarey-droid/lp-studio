  ...
  return (
    <section className={cn("w-full bg-[#F0F7F4] px-6 relative overflow-hidden", sectionPy)}>
      <div className="max-w-4xl mx-auto relative z-10 flex flex-col items-center text-center">
        ...
        <blockquote className={cn("text-2xl md:text-4xl font-display text-[var(--brand-primary)] leading-snug mb-10", getHeadingWeightClass(brand), getHeadingLetterSpacingClass(brand))}>
          "<InlineText value={props.quote} onUpdate={field("quote")} className={cn("text-2xl md:text-4xl font-display text-[var(--brand-primary)] leading-snug", getHeadingWeightClass(brand), getHeadingLetterSpacingClass(brand))} multiline />"
        </blockquote>
