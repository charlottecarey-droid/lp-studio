  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <span aria-hidden style={{ width: 28, height: 1, background: theme.divider }} />
        ...
        >
          <div>
            ...
            >
              ...
              {props.eyebrow}
              <span aria-hidden style={{ width: 28, height: 1, background: theme.accent, opacity: 0.5 }} />
            </motion.div>
            <motion.h1
              initial={{ opacity: 0, y: 10 }}
              animate={{ opacity: 1, y: 0 }}
      ...
      <section style={{ maxWidth: "80rem", margin: "0 auto", padding: "0 1.5rem 5rem" }}>
        ...
        >
          ...
          <span style={{ flex: 1, height: 1, background: theme.divider }} aria-hidden />
        </div>
      ...
      >
        ...
        >
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}>
            ...
            >
              <span style={{ textTransform: "uppercase", letterSpacing: "0.18em", fontWeight: 600 }}>Sort</span>
              ...
              >
                ...
                <span
                  style={{
                    ...
                    borderRadius: 999,
                    background: isActive ? "rgba(255,255,255,0.18)" : theme.divider,
        ...
        >
          ...
          {activeFilter !== defaultFilter && (
            <>
              {" · "}
              <span style={{ color: theme.accent }}>{activeFilter}</span>
              <button
                type="button"
      ...
      >
        ...
        >
          <span aria-hidden style={{ width: 28, height: 1, background: theme.accent, opacity: 0.6 }} />
          From the archive
          <span aria-hidden style={{ width: 28, height: 1, background: theme.accent, opacity: 0.6 }} />
        </div>
        <blockquote
      ...
      >
        <span>Customer Stories · Vol. III · Issue 04</span>
        <span>Set in {(theme.displayFontFamily || "Cormorant Garamond").replace(/['"]/g, "")} & {(theme.bodyFontFamily || "Inter").replace(/['"]/g, "")}</span>
      </footer>
    </div>
  );
}
...
function StoryCard({
    ...
    return (
      ...
      >
        ...
        <div>
          ...
          >
            <span style={{ color: theme.accent }}>{editionNo}</span>
            <span>·</span>
            <span>{story.tag}</span>
            <span>·</span>
  ...
  return (
    ...
    >
      ...
      >
        <span style={{ color: theme.accent }}>{editionNo}</span>
        <span aria-hidden style={{ flex: 1, height: 1, background: theme.divider }} />
        <span>{readTime} min read</span>
      </div>
