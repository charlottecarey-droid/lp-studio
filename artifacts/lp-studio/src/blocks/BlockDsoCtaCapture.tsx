...
export function BlockDsoCtaCapture({ props, pageId, variantId, prefillCompany, isBuilder }: Props) {
  ...
  const borderDefault = dark ? "rgba(199,231,56,0.18)"  : "rgb(var(--brand-primary-rgb, 0 58 48) / 0.20)";
  const borderFocused = dark ? "rgba(199,231,56,0.50)"  : "rgb(var(--brand-primary-rgb, 0 58 48) / 0.40)";
        ...
        >
          ...
          >
            <span style={{
              ...
              background: AW, boxShadow: `0 0 0 3px ${dark ? "rgba(199,231,56,0.18)" : "rgb(var(--brand-primary-rgb, 0 58 48) / 0.12)"}`,
              flexShrink: 0,
            }} />
          ...
          {isSuccess ? (
            <motion.div
              ...
              style={{
                ...
                maxWidth: 480,
                background: dark ? "rgba(199,231,56,0.07)" : "rgb(var(--brand-primary-rgb, 0 58 48) / 0.06)",
                border: `1px solid ${dark ? "rgba(199,231,56,0.22)" : "rgb(var(--brand-primary-rgb, 0 58 48) / 0.20)"}`,
                borderRadius: "1rem",
            ...
            >
              {inputLabel && (
                <p style={{ fontSize: "0.6875rem", fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase", color: dark ? "rgba(199,231,56,0.6)" : "rgb(var(--brand-primary-rgb, 0 58 48) / 0.55)", marginBottom: "0.65rem" }}>
                  {inputLabel}
                </p>
              )}
              ...
              >
                ...
                <div
                  style={{
                    ...
                    boxShadow: focused1 ? `0 0 0 3px ${dark ? "rgba(199,231,56,0.08)" : "rgb(var(--brand-primary-rgb, 0 58 48) / 0.06)"}` : "none",
              ...
              {trusts.map((t, i) => (
                <span key={i} style={{ display: "flex", alignItems: "center", gap: "0.45rem" }}>
                  <svg width="13" height="13" viewBox="0 0 13 13" fill="none">
                    <circle cx="6.5" cy="6.5" r="6" stroke={dark ? "rgba(199,231,56,0.35)" : "rgb(var(--brand-primary-rgb, 0 58 48) / 0.25)"} strokeWidth="1" />
