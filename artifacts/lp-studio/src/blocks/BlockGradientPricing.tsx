            ...
            return (
              ...
              >
                {tier.badge && featured && (
                  ...
                  >
                    <InlineText as="span" value={tier.badge} onUpdate={updateTier ? (v) => updateTier(i, { badge: v }) : undefined} />
                  </div>
                )}
                <div className="text-sm font-semibold uppercase tracking-widest text-white/60">
                  <InlineText as="span" value={tier.name} onUpdate={updateTier ? (v) => updateTier(i, { name: v }) : undefined} />
                </div>
                <div className="mt-6 flex items-baseline gap-1">
                  ...
                  >
                    <InlineText as="span" value={tier.price} onUpdate={updateTier ? (v) => updateTier(i, { price: v }) : undefined} />
                  </span>
                  {tier.period && (
                    <span className="text-white/50 text-base">
                      <InlineText as="span" value={tier.period} onUpdate={updateTier ? (v) => updateTier(i, { period: v }) : undefined} />
                    </span>
                  )}
                </div>
                {tier.description && (
                ...
                {onFieldChange ? (
                  <span
                    className={cn(
                      "mt-8 inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-full font-semibold",
                    )}
                    style={
                      featured
                  ...
                  >
                    <InlineText as="span" value={tier.ctaText} onUpdate={updateTier ? (v) => updateTier(i, { ctaText: v }) : undefined} />
