      ...
      <div className="w-1/2 h-full flex items-center justify-center p-6 bg-white">
        <div className="w-full h-full bg-white rounded-3xl flex items-center justify-center p-10 relative">
          ...
          <motion.div
            ...
            transition={{ duration: 1.2, delay: 2.0, times: [0, 0.2, 0.7, 1] }}
          >
            {[0, 0.2, 0.4].map((delay, i) => (
              <motion.div
                ...
                transition={{ duration: 0.8, delay: 2.1 + delay, repeat: 2, repeatType: 'loop', ease: 'easeInOut' }}
              />
            ))}
          </motion.div>
          ...
          <motion.div
            className="absolute top-64 left-28 bg-[#003A30] text-white px-5 py-3 rounded-2xl rounded-tr-none shadow-lg max-w-[220px]"
