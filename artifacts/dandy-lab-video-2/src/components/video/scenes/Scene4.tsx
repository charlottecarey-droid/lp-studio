    ...
    >
      ...
      <div className="w-1/2 h-full flex items-center justify-center p-6 bg-white">
        <div className="w-full h-full bg-white rounded-3xl flex items-center justify-center p-10 relative">
          ...
          <motion.div
            className="absolute top-52 left-8 bg-[#F0F4F2] px-4 py-2 rounded-2xl rounded-tl-none shadow-md flex items-center gap-1"
          ...
          <motion.div
            className="absolute top-64 left-8 bg-[#003A30] text-white px-5 py-3 rounded-2xl rounded-tl-none shadow-lg max-w-[220px]"
