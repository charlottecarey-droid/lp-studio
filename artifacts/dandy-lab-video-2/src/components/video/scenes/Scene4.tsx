  ...
  return (
    ...
    >
      ...
      <div className="w-1/2 h-full flex items-center justify-center p-6 bg-white">
        ...
        {/* Live Chat badge */}
        <motion.div
          className="absolute bottom-36 left-8 bg-white px-5 py-3 rounded-2xl shadow-lg border border-gray-100 flex items-center gap-3"
        ...
        <motion.div
          className="absolute top-32 right-28 bg-[#003A30] text-white px-5 py-3 rounded-2xl rounded-tr-none shadow-lg max-w-[220px]"
        ...
        {/* Typing indicator */}
        <motion.div
          className="absolute top-20 right-28 bg-white px-4 py-2 rounded-2xl rounded-tr-none shadow-md border border-gray-100 flex items-center gap-1"
