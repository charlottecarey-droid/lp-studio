    ...
    <div className="min-h-screen bg-[#f6f5ee] text-slate-800 font-sans selection:bg-[#c8e84e] selection:text-[#0d1f15]">
      ...
      <section className="relative w-full h-[720px] flex overflow-hidden bg-[#0d1f15]">
        ...
        <div className="w-[55%] h-full flex flex-col justify-between p-12 lg:p-20 z-10">
          ...
          <div className="max-w-2xl mt-12">
            ...
            <h1 className="text-white font-['Bagoss_Standard'] text-5xl lg:text-6xl xl:text-7xl leading-[1.05] tracking-tight mb-8">
      ...
      <section className="px-12 lg:px-20 py-24 lg:py-32 max-w-7xl mx-auto border-b border-black/10">
        <div className="flex items-center gap-4 mb-16">
          <span className="text-black/40 font-['Bagoss_Standard'] text-xl italic">01</span>
          <h2 className="text-[#0f2a1c] font-['Bagoss_Standard'] text-4xl lg:text-5xl">The Situation</h2>
        </div>
      ...
      <section className="px-12 lg:px-20 py-24 lg:py-32 max-w-7xl mx-auto border-b border-black/10">
        <div className="flex items-center gap-4 mb-16">
          <span className="text-black/40 font-['Bagoss_Standard'] text-xl italic">02</span>
          <div className="flex items-center gap-3">
            ...
            <span className="text-[#0f2a1c] font-['Bagoss_Standard'] text-3xl">Dandy adoption is accelerating</span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white p-10 shadow-sm border border-slate-100 flex flex-col justify-between">
            <div>
              ...
              <h3 className="font-['Bagoss_Standard'] text-4xl text-[#0f2a1c] mb-4">+312%</h3>
          ...
          <div className="bg-white p-10 shadow-sm border border-slate-100 flex flex-col justify-between">
            <div>
              ...
              <h3 className="font-['Bagoss_Standard'] text-4xl text-[#0f2a1c] mb-4">1 in 3</h3>
          ...
          <div className="bg-[#0f2a1c] p-10 shadow-sm flex flex-col justify-between text-white relative overflow-hidden">
            ...
            <div className="relative z-10">
              <p className="font-['Bagoss_Standard'] text-xl italic leading-snug mb-8 text-white/90">
      ...
      <section className="px-12 lg:px-20 py-24 lg:py-32 max-w-7xl mx-auto border-b border-black/10">
        <div className="flex items-center gap-4 mb-16">
          <span className="text-black/40 font-['Bagoss_Standard'] text-xl italic">03</span>
          <h2 className="text-[#0f2a1c] font-['Bagoss_Standard'] text-4xl lg:text-5xl">The Cost of Inaction</h2>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-12 gap-y-16">
          <div>
            <div className="text-5xl font-['Bagoss_Standard'] text-[#0f2a1c] mb-4 border-b-2 border-black/5 pb-4">7%</div>
          ...
          <div>
            <div className="text-5xl font-['Bagoss_Standard'] text-[#0f2a1c] mb-4 border-b-2 border-black/5 pb-4">120+</div>
          ...
          <div>
            <div className="text-5xl font-['Bagoss_Standard'] text-[#0f2a1c] mb-4 border-b-2 border-black/5 pb-4">$40k</div>
          ...
          <div>
            <div className="text-5xl font-['Bagoss_Standard'] text-[#0f2a1c] mb-4 border-b-2 border-black/5 pb-4">4-6</div>
      ...
      <section className="px-12 lg:px-20 py-24 lg:py-32 bg-[#1a1a1a]">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-4 mb-20">
            <span className="text-white/30 font-['Bagoss_Standard'] text-xl italic">04</span>
            <h2 className="text-white font-['Bagoss_Standard'] text-4xl lg:text-5xl">The Paradigm Shift</h2>
          </div>
      ...
      <section className="px-12 lg:px-20 py-24 lg:py-32 max-w-7xl mx-auto border-b border-black/10">
        <div className="flex items-center justify-between mb-16">
          <div className="flex items-center gap-4">
            <span className="text-black/40 font-['Bagoss_Standard'] text-xl italic">05</span>
            <h2 className="text-[#0f2a1c] font-['Bagoss_Standard'] text-4xl lg:text-5xl">The Math</h2>
          </div>
        ...
        <div className="bg-white border border-slate-200 shadow-sm p-8 lg:p-12">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12 border-b border-slate-100 pb-12">
            <div>
              ...
              <div className="text-2xl font-['Bagoss_Standard'] text-[#0f2a1c] border-b border-slate-300 pb-2">{`{practice_count}`}</div>
            </div>
            <div>
              <label className="block text-xs font-bold uppercase tracking-wider text-slate-500 mb-3">Est. Monthly Case Volume</label>
              <div className="text-2xl font-['Bagoss_Standard'] text-[#0f2a1c] border-b border-slate-300 pb-2">~450</div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-[#f9f8f4] p-6">
              ...
              <div className="text-3xl font-['Bagoss_Standard'] text-[#0f2a1c] text-[#0d1f15] mb-2">+12%</div>
            ...
            <div className="bg-[#f9f8f4] p-6">
              ...
              <div className="text-3xl font-['Bagoss_Standard'] text-[#0f2a1c] mb-2">1,200+</div>
            ...
            <div className="bg-[#f9f8f4] p-6">
              ...
              <div className="text-3xl font-['Bagoss_Standard'] text-[#0f2a1c] mb-2">$850k</div>
            ...
            <div className="bg-[#0d1f15] p-6 text-white">
              ...
              <div className="text-3xl font-['Bagoss_Standard'] mb-2">Immediate</div>
      ...
      <section className="px-12 lg:px-20 py-24 lg:py-32 max-w-7xl mx-auto border-b border-black/10">
        <div className="flex items-center gap-4 mb-16">
          <span className="text-black/40 font-['Bagoss_Standard'] text-xl italic">06</span>
          <h2 className="text-[#0f2a1c] font-['Bagoss_Standard'] text-4xl lg:text-5xl">The Proof</h2>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
          <div className="lg:col-span-8">
            <Quote className="w-12 h-12 text-[#c8e84e] mb-8" />
            <h3 className="text-3xl lg:text-4xl font-['Bagoss_Standard'] text-[#0f2a1c] leading-tight mb-8">
          ...
          <div className="lg:col-span-4 space-y-12 lg:border-l lg:border-slate-200 lg:pl-12">
            <div>
              <p className="text-lg font-['Bagoss_Standard'] text-[#0f2a1c] italic leading-relaxed mb-6">
      ...
      <section className="px-12 lg:px-20 py-24 lg:py-32 max-w-7xl mx-auto">
        <div className="flex items-center gap-4 mb-20">
          <span className="text-black/40 font-['Bagoss_Standard'] text-xl italic">07</span>
          <h2 className="text-[#0f2a1c] font-['Bagoss_Standard'] text-4xl lg:text-5xl">The Plan</h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 relative">
          ...
          <div className="relative z-10">
            <div className="w-12 h-12 bg-[#f6f5ee] border-2 border-[#0f2a1c] rounded-full flex items-center justify-center font-['Bagoss_Standard'] text-xl text-[#0f2a1c] mb-6">01</div>
          ...
          <div className="relative z-10">
            <div className="w-12 h-12 bg-[#f6f5ee] border-2 border-[#0f2a1c] rounded-full flex items-center justify-center font-['Bagoss_Standard'] text-xl text-[#0f2a1c] mb-6">02</div>
          ...
          <div className="relative z-10">
            <div className="w-12 h-12 bg-[#f6f5ee] border-2 border-[#0f2a1c] rounded-full flex items-center justify-center font-['Bagoss_Standard'] text-xl text-[#0f2a1c] mb-6">03</div>
          ...
          <div className="relative z-10">
            <div className="w-12 h-12 bg-[#f6f5ee] border-2 border-[#0f2a1c] rounded-full flex items-center justify-center font-['Bagoss_Standard'] text-xl text-[#0f2a1c] mb-6">04</div>
      ...
      <section className="bg-[#0d1f15] py-24 lg:py-32 px-12 lg:px-20 text-center">
        <div className="max-w-3xl mx-auto flex flex-col items-center">
          ...
          <h2 className="text-white font-['Bagoss_Standard'] text-4xl lg:text-6xl leading-tight mb-8">
