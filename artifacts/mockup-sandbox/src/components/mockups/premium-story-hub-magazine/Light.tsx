...
function StoryHub({ mode }: { mode: 'light' | 'dark' }) {
  ...
  return (
    <div 
      className="min-h-screen w-full selection:bg-[#FF5A1F] selection:text-white"
      ...
      <main className="max-w-[1440px] mx-auto px-6 md:px-12 py-16 md:py-24">
            ...
            return (
              ...
              >
                ...
                <div className="relative z-10 h-full flex flex-col">
                  ...
                  <div className="flex-1 flex flex-col justify-between" style={{ color: i === 0 ? (isLight ? palette.text : '#fff') : palette.text }}>
                    <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-16 md:gap-8">
            {[
              ...
              <div key={i} className="text-center relative">
                <div className="absolute inset-0 mx-auto w-32 h-32 rounded-full -z-10 blur-2xl opacity-20" style={{ backgroundColor: palette.secondary }} />
        ...
        <div className="text-center py-16 md:py-32">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
            <button 
              className="px-10 py-5 text-sm font-bold uppercase tracking-widest transition-transform hover:scale-105"
