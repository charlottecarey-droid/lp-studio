...
const theme = {
  ...
  textMuted: "#888888",
  accent: "#00E5FF",
  accentMuted: "rgba(0, 229, 255, 0.1)",
...
export default function LinearDark() {
      ...
      <section id="vision" style={{ padding: "120px 24px", textAlign: "center", position: "relative", overflow: "hidden" }}>
        <div
          style={{
            ...
            width: "800px",
            height: "800px",
            background: `radial-gradient(circle, ${theme.accentMuted} 0%, rgba(0,0,0,0) 70%)`,
            zIndex: 0,
            pointerEvents: "none",
          }}
        />
        <div style={{ position: "relative", zIndex: 1, maxWidth: "1000px", margin: "0 auto" }}>
          ...
          <FadeIn delay={0.4}>
            ...
            >
              <div style={{ height: "40px", borderBottom: `1px solid ${theme.border}`, display: "flex", alignItems: "center", padding: "0 16px", gap: "8px" }}>
                <div style={{ width: "12px", height: "12px", borderRadius: "50%", background: theme.border }} />
                <div style={{ width: "12px", height: "12px", borderRadius: "50%", background: theme.border }} />
                <div style={{ width: "12px", height: "12px", borderRadius: "50%", background: theme.border }} />
              </div>
              <div style={{ flex: 1, padding: "24px", fontFamily: theme.fontMono, fontSize: "14px", color: theme.textMuted, textAlign: "left" }}>
                ...
                &nbsp;&nbsp;theme: <span style={{ color: "#A5D6FF" }}>'dark'</span>,<br />
      ...
      <section id="features" style={{ padding: "120px 24px" }}>
        <div style={{ maxWidth: "1200px", margin: "0 auto", display: "flex", flexDirection: "column", gap: "160px" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "64px", alignItems: "center" }}>
            <FadeIn>
              <div>
                <div style={{ fontSize: "14px", color: "#FF00FF", fontFamily: theme.fontMono, marginBottom: "16px" }}>SPEED</div>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
                  {["Memory safe execution", "Multi-threaded indexing", "GPU-accelerated rendering"].map((item, i) => (
                    <div key={i} style={{ display: "flex", alignItems: "center", gap: "12px", color: theme.textMuted }}>
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#FF00FF" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12" /></svg>
                      {item}
                    </div>
                  ))}
                </div>
            ...
            <FadeIn delay={0.2}>
              <div style={{ aspectRatio: "1/1", background: `linear-gradient(135deg, rgba(255,0,255,0.1), transparent)`, border: `1px solid ${theme.border}`, borderRadius: "24px", display: "flex", alignItems: "center", justifyContent: "center" }}>
                <div style={{ width: "200px", height: "200px", borderRadius: "50%", background: "radial-gradient(circle, rgba(255,0,255,0.4) 0%, transparent 70%)" }} />
              </div>
            </FadeIn>
          </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "64px", alignItems: "center" }}>
            <FadeIn delay={0.2}>
              <div style={{ aspectRatio: "1/1", background: `linear-gradient(135deg, rgba(0,255,100,0.1), transparent)`, border: `1px solid ${theme.border}`, borderRadius: "24px", display: "flex", alignItems: "center", justifyContent: "center" }}>
                <div style={{ width: "200px", height: "200px", borderRadius: "50%", background: "radial-gradient(circle, rgba(0,255,100,0.4) 0%, transparent 70%)" }} />
              </div>
            </FadeIn>
            <FadeIn>
              <div>
                <div style={{ fontSize: "14px", color: "#00FF64", fontFamily: theme.fontMono, marginBottom: "16px" }}>INTELLIGENCE</div>
                <h2 style={{ fontSize: "48px", fontWeight: 700, letterSpacing: "-0.03em", marginBottom: "24px", lineHeight: 1.1 }}>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
                  {["Context-aware completions", "Automated test generation", "Semantic code search"].map((item, i) => (
                    <div key={i} style={{ display: "flex", alignItems: "center", gap: "12px", color: theme.textMuted }}>
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#00FF64" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12" /></svg>
                      {item}
                    </div>
                  ))}
                </div>
        ...
        <div style={{ maxWidth: "1000px", margin: "0 auto" }}>
          ...
          <div style={{ fontFamily: theme.fontMono, fontSize: "14px" }}>
            ...
            {[
              ...
              <div key={i} style={{ display: "grid", gridTemplateColumns: "2fr 1fr 1fr 1fr", padding: "16px", borderBottom: `1px solid ${theme.border}`, background: i % 2 === 0 ? "transparent" : "rgba(255,255,255,0.02)" }}>
              ...
              <FadeIn key={i} delay={i * 0.1}>
                <div
                  style={{
                    ...
                    background: plan.popular ? theme.surfaceHover : theme.surface,
                    position: "relative",
                  }}
                >
                  {plan.popular && (
                    <div style={{ position: "absolute", top: "-12px", left: "50%", transform: "translateX(-50%)", background: theme.accent, color: "#000", padding: "4px 12px", borderRadius: "12px", fontSize: "12px", fontWeight: 600 }}>
                      Most Popular
                    </div>
                  )}
                  ...
                  <button
                    style={{
                      ...
                      borderRadius: "8px",
                      border: "none",
                      background: plan.popular ? theme.text : theme.bg,
                      color: plan.popular ? theme.bg : theme.text,
                      fontWeight: 600,
                      cursor: "pointer",
                      marginBottom: "32px",
