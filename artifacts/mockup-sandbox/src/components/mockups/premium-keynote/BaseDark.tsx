...
export default function BaseDark() {
  ...
  return (
    <div style={{ backgroundColor: theme.bg, color: theme.text, minHeight: "100vh", fontFamily: "sans-serif" }}>
      ...
      >
        ...
        >
          <div style={{ position: "absolute", inset: 0, background: "radial-gradient(circle at 50% 50%, rgba(0,0,0,0.4) 0%, transparent 100%)" }} />
          {/* Abstract Turntable Shape */}
          <div style={{ position: "absolute", top: "50%", left: "50%", transform: "translate(-50%, -50%)", width: "60%", height: "60%", borderRadius: "50%", border: `1px solid ${theme.border}`, opacity: 0.5 }} />
          <div style={{ position: "absolute", top: "50%", left: "50%", transform: "translate(-50%, -50%)", width: "55%", height: "55%", borderRadius: "50%", border: `1px solid ${theme.border}`, opacity: 0.8 }} />
          <div style={{ position: "absolute", top: "50%", left: "50%", transform: "translate(-50%, -50%)", width: "10%", height: "10%", borderRadius: "50%", background: theme.border }} />
        </motion.div>
      </section>
      ...
      <div style={{ padding: "120px 24px", display: "flex", flexDirection: "column", gap: 160, maxWidth: 1200, margin: "0 auto" }}>
        ...
        <section id="fidelity" style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(400px, 1fr))", gap: 64, alignItems: "center" }}>
          <motion.div initial={{ opacity: 0, scale: 0.95 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} style={{ aspectRatio: "1/1", backgroundColor: theme.surface, borderRadius: 24, padding: 32, position: "relative", overflow: "hidden", border: `1px solid ${theme.border}`, order: 2 }}>
             ...
             <div style={{ position: "absolute", top: 40, left: -20, width: 200, height: 12, backgroundColor: theme.text, transform: "rotate(-35deg)", opacity: 0.2 }} />
          </motion.div>
        ...
        <section id="connectivity" style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(400px, 1fr))", gap: 64, alignItems: "center" }}>
          ...
          <motion.div initial={{ opacity: 0, scale: 0.95 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} style={{ aspectRatio: "1/1", backgroundColor: theme.surface, borderRadius: 24, padding: 32, position: "relative", overflow: "hidden", border: `1px solid ${theme.border}` }}>
             ...
             <div style={{ position: "absolute", top: "50%", left: "50%", transform: "translate(-50%, -50%)", width: 100, height: 100, borderRadius: 50, border: `2px dashed ${theme.accent3}`, opacity: 0.3 }} />
             <div style={{ position: "absolute", top: "50%", left: "50%", transform: "translate(-50%, -50%)", width: 150, height: 150, borderRadius: 75, border: `1px dashed ${theme.accent3}`, opacity: 0.15 }} />
          </motion.div>
        </section>
